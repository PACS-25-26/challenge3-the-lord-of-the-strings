...
Doxyfile is automatically generated by `CMakeLists.txt`. Once the build directory is filled, one can generate the documentation using the command

```txt
make doc
```

which will automatically generate and open the documentation.